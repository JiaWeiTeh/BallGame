...
class Ball:
    ...
    def update(self, dt):
        ...
        if (self.pos[0] >= barR.pos[0] - 3 and self.pos[0] < boardx) or\
            (self.pos[0] <= barL.pos[0] + 3 and self.pos[0] > 0):
        ...
        """Problem now: ball will sometime go pass barR. Will sometimes also 
        reflect eventhough clearly misses barL""""
